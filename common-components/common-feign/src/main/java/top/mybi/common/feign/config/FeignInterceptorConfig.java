...
import top.mybi.common.core.constants.SecurityConstants;
import top.mybi.common.core.context.TenantContextHolder;
...
public class FeignInterceptorConfig {
    ...
    public void initialize() {
        ...
        requestHeaders.add(CommonConstants.mybi_VERSION);//负载均衡策略-版本号 信息头
