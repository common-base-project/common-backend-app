...
public class FeignServiceException extends RuntimeException {
     ...
     * @param msg
     */
    public FeignServiceException(String code, String msg) {
        super(msg);
        this.code = code;
        this.msg = msg;
    }
     ...
     * @param msg
     */
    public FeignServiceException(String code, String msg, String innerMsg) {
        super(msg);
        this.code = code;
        this.msg = msg;
     ...
     * @param result
     */
    public FeignServiceException(Result result) {
        super(result.getMsg());
     ...
     * @param message
     */
    public FeignServiceException(IErrorCode message){
     ...
     * @param message
     */
    public FeignServiceException(IErrorCode message, String msg){
